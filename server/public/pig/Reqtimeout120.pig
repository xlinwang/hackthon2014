...
Y = FILTER A BY duration > 10000;
C = FOREACH Y GENERATE name,REGEX_EXTRACT(records, 'X-EBAY-API-SITEID=([0-9]+)', 1) as siteId,REGEX_EXTRACT(records, 'X-EBAY-API-COMPATIBILITY-LEVEL=([0-9]+)', 1) as version;

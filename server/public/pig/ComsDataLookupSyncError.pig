...
Y = FILTER XX BY name MATCHES 'COMS_BES_LookupSync_Order';
YY = FILTER Y BY data MATCHES 'Cannont Synchronize Order.*';
D = GROUP YY BY name;
E = FOREACH D GENERATE group, COUNT(YY.name), 'Cannont Synchronize Order' , 'Error occured syncing index';

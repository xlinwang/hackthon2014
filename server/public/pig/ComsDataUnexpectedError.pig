...
Y = FILTER XX BY name MATCHES 'COMS_BES_Error_COMS.LOOKUP.SYNC_UnexpectedFailure';
D = GROUP Y BY status;
E = FOREACH D GENERATE group, COUNT(Y.status) , 'COMS_BES_Error_COMS.LOOKUP.SYNC_UnexpectedFailure';
